...
export default function CustomDialog({
  ...
  const [formData, setFormData] = useState({
    lokasiKantor: lokasiKantor?.lokasiKantor || "",
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === "add") {
        setFormData({ lokasiKantor: "" });
      }

      // Tambahkan notifikasi sukses jika diperlukan
      alert(
        `Lokasi kantor berhasil ${
          ...
          <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold">
                {mode === "add" ? "Tambah" : "Edit"} Lokasi Kantor
              </h3>
              <button
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, lokasiKantor: e.target.value })
                  }
