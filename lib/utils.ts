...
export const viewFieldGroups = [
  {
    ...
    fields: [
      ...
      { label: "provinsi", name: "provinsi", type: "select" },
      { label: "Kabupaten", name: "kabupaten", type: "select" },
      { label: "Kecamatan", name: "kecamatan", type: "select" },
      { label: "Kelurahan", name: "kelurahan", type: "select" },
